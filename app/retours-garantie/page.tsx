...
export const metadata: Metadata = { title: 'Retours et garantie' }
...
export default async function RetoursGarantiePage() {
  const content = await getContent()
  return (
    <div className="py-16">
      <div className="jc-container max-w-2xl">
        <h1 className="text-3xl font-bold mb-10">Retours et garantie</h1>
        {content ? (
